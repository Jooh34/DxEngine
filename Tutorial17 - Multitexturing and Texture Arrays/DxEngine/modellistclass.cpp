...
bool ModelListClass::Initialize(int numModels)
{
	...
	//First store the number of models that will be usedand then create the list array of them using the ModelInfoType structure.
...
//The GetData function extracts the positionand color of a sphere at the given input index location.
