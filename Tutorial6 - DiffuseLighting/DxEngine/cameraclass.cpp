...
//The SetPositionand SetRotation functions are used for setting up the positionand rotation of the camera.
...
void CameraClass::Render()
{
	...
	XMVECTOR position = XMVectorSet(m_positionX, m_positionY, m_positionZ, 0.f);
